        ...
        <main>
            <div class="container">
                ...
                <table class="laporan-table">
                  ...
                  <?php
                  include '../global/connect.php';
                  $result = mysqli_query($connect, "SELECT k.ID_Laporan, k.ID_user, a.ID_Perbaikan, p.ID_produk, p.Nama FROM kualitas_produk k INNER JOIN perbaikan a ON  k.ID_Laporan=a.ID_Laporan INNER JOIN produk p ON k.ID_produk=p.ID_produk WHERE a.evaluasi IS NOT NULL and a.evaluasi!= '';");
                  ?>
                    <tbody>
                  <?php
