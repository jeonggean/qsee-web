        ...
        <main>
            <div class="container">
                ...
                <?php
                    ...
                    $result = mysqli_query($connect, "SELECT k.ID_Laporan, a.ID_user, a.ID_approved, p.ID_produk, p.Nama FROM kualitas_produk k INNER JOIN approved a ON  k.ID_Laporan=a.ID_Laporan INNER JOIN produk p ON k.ID_produk = p.ID_produk WHERE a.statuses = 'Belum_Terbaca' OR a.statuses ='' ;");
                ?>
                    <tbody>
                       <?php while  ($data = mysqli_fetch_assoc($result)){?>
                        <tr>
                            <td><?= $data['ID_user'] ?></td>
                            <td><?= $data['ID_approved'] ?></td>
