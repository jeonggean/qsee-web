            ...
            <div class="container">
                <table class="laporan-table">
                  ...
                  <?php
                    ...
                    $result = mysqli_query($connect, "SELECT k.ID_Laporan, k.ID_user, m.ID_pembuangan, p.ID_produk, p.Nama FROM kualitas_produk k INNER JOIN pembuangan m ON  k.ID_Laporan=m.ID_Laporan INNER JOIN produk p ON k.ID_produk=p.ID_produk;");
                  ?>
                  <?php
