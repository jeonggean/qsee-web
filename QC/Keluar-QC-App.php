        ...
        <main>
            <div class="container">
                ...
                <?php
                  ...
                  $result = mysqli_query($connect, "SELECT k.ID_Laporan, a.ID_user, a.ID_Approved, p.ID_produk, p.Nama FROM kualitas_produk k INNER JOIN approved a ON  k.ID_Laporan=a.ID_Laporan INNER JOIN produk p ON k.ID_produk = p.ID_produk;");
